...
$to = "support@allen-allen.jp,lp@reform-park.jp,reformpark2023@gmail.com,reformpark2025@gmail.com,reform.park.crm@gmail.com";
...
$tel = isset($_POST['tel']) ? $_POST['tel'] : '未入力';
$subject = "【Google広告/一般LP】お問合わせがありました。（" . date("Y-m-d H:i:s") . "｜" . $tel . "）";
